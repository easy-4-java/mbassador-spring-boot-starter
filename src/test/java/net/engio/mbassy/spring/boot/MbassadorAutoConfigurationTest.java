 ...
 * @since 1.0.0
 */
@DisplayName("MbassadorAutoConfiguration Tests")
class MbassadorAutoConfigurationTest {
    ...
    @Test
    @DisplayName("Auto-configuration loads when 'spring.mbassador.enabled=true'")
